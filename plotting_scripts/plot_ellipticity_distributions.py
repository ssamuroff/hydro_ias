...
illustris = fi.FITS('data/cats/fits/Illustris-1_85_non-reduced_galaxy_shapes.fits')[-1].read()
mbii = fi.FITS('data/cats/fits/mbii-ndm1000-nst300-snapshot85.fits')[-1].read()
