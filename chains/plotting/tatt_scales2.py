...
class plot2D(plots.MultinestPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colors=['k', 'royalblue', 'darkmagenta','forestgreen','royalblue', 'k','pink','steelblue',"purple", 'k', 'k', 'k', 'k']*10
        self.linestyles=['-','--','-',':']*10
        ...
        matplotlib.rcParams['font.family']='serif'
        self.labels= [ r'$r_{\rm p} > 2 h^{-1}$ Mpc',
                      r'$r_{\rm p} > 4 h^{-1}$ Mpc',
                      r'$r_{\rm p} > 6 h^{-1}$ Mpc$',
                      r'$z=1.0$',
        ...
        self.axis=[-1.,5,-5.,5]
        self.fill_list=[False,False,True,False,False,False,False,True,True,True]*10
