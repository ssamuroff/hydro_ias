...
class plot2D(plots.MultinestPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colors=[ 'darkmagenta', 'royalblue','forestgreen','royalblue', 'k','pink','steelblue',"purple", 'k', 'k', 'k', 'k']*10
        self.linestyles=['-','--','-',':']*10
        ...
        matplotlib.rcParams['font.family']='serif'
        self.labels= [ r'$w_{gg}+w_{g+}+w_{++}$ $(r_{\rm p} > 6 h^{-1} \mathrm{Mpc})$',
                      r'1pt Likelihood',
                      r'$z=0.62$',
                      r'$z=1.0$',
        ...
        self.axis=[-0.1,2.8,0.05,3.]
        self.fill_list=[True,True,False,True,False,False,False,False,True,True,True]*10
    ...
    def run(self):
        ...
        name2="intrinsic_alignment_parameters--bias_ta"
    ...
    def make_2d_plot(self, name1, name2):
        ...
        if self.labels is not None:
            leg=pylab.legend(self.proxies,self.labels,loc="upper right", fontsize=15)
        ...
        pylab.ylabel(r"$b_{\rm TA}$",fontsize=22, fontname='serif')
