...
class plot2D(plots.MultinestPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colors=[ 'k', 'forestgreen', 'darkmagenta','purple','royalblue', 'k','pink','steelblue',"purple", 'k', 'k', 'k', 'k']*10
        self.linestyles=['--','-','-',':']*10
        ...
        matplotlib.rcParams['font.family']='serif'
        self.labels= [ r'Covariance Iteration 1',
                      r'Covariance Iteration 2',
                      r'Covariance Iteration 3',
        ...
        self.axis=[0.5,1.4,1.3,3.8]
        self.fill_list=[False,False,True,False,False,False,False,False,True,True,True]*10
        ...
        self.alphas=[0.2,0.6,0.2,0.6,0.4,0.4,0.4]*len(self.colors)
    ...
    def run(self):
        name1="bias_parameters--b_0_062"
        name2="intrinsic_alignment_parameters--a_0_062"
    ...
    def make_2d_plot(self, name1, name2):
        ...
        if self.labels is not None:
            leg=pylab.legend(self.proxies,self.labels,loc="upper left", fontsize=20)
