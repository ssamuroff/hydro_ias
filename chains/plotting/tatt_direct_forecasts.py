...
class plot2D(plots.MultinestPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colors=['grey', 'royalblue', 'darkmagenta', 'orange','pink', 'k','pink','steelblue',"purple", 'k', 'k', 'k', 'k']*10
        self.linestyles=[':','-','--','-',':']*10
        ...
        matplotlib.rcParams['font.family']='serif'
        self.labels= [ r'1pt Likelihood, TNG300',
                       r'2pt Likelihood, TNG500',
                       r'2pt Likelihood, TNG1000',
        ...
        self.axis=[0.45,2.8,-1.35,0.7]
        self.fill_list=[True,False,True,True,False,False,False,False,True,True,True]*10
        ...
        self.plot_points=[(1.820805, -0.3533341)]
        #self.proxies=[]
