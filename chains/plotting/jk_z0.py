...
class plot2D(plots.MultinestPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fill_list=[True,False,False,False,False,False,False,False,True,True,True]*10
        ...
        self.alphas=[0.2,0.6,0.6,0.6,0.4,0.4,0.4]*len(self.colors)
