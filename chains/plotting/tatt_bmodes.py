...
class plot2D(plots.MultinestPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colors=['darkmagenta', 'royalblue', 'darkmagenta','forestgreen','royalblue', 'k','pink','steelblue',"purple", 'k', 'k', 'k', 'k']*10
        self.linestyles=['-','--','-',':']*10
        ...
        matplotlib.rcParams['font.family']='serif'
        self.labels= [ r'Modelling B-Modes',
                      r'Not Modelling B-Modes',
                      r'$r_{\rm p} > 6 h^{-1}$ Mpc$',
                      r'$z=1.0$',
        ...
        self.axis=[-0.5,3.,-2.2,2.9]
        self.fill_list=[True,False,True,False,False,False,False,True,True,True]*10
