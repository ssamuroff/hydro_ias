...
class plot2D(plots.MultinestPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colors=[ 'darkmagenta', 'k', 'royalblue','forestgreen','royalblue', 'k','pink','steelblue',"purple", 'k', 'k', 'k', 'k']*10
        self.linestyles=['-',':','-',':']*10
        ...
        matplotlib.rcParams['font.family']='serif'
        self.labels= [ r'Analytic cov.', r'Jackknife cov.']

        self.axis=[-1.,3.5,-3,2.5]
