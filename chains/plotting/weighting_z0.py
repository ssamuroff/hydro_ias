...
class plot2D(plots.MultinestPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colors=['midnightblue','midnightblue','forestgreen','forestgreen', 'k','pink','steelblue',"purple", 'k', 'k', 'k', 'k']*10
        self.linestyles=['-',':','-',':']*10
        ...
        matplotlib.rcParams['font.family']='serif'
        self.labels= [ r'MassiveBlack-II, weighted',
                      r'MassiveBlack-II, unweighted',
                      r'Illustris, weighted',
                      r'Illustris, unweighted',
        ...
        self.fill_list=[True,False,True,False,False,False,False,False,True,True,True]*10
