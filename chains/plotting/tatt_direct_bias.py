...
class plot2D(plots.MultinestPlots2D):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.colors=[ 'darkmagenta', 'royalblue','forestgreen','pink', 'k','pink','steelblue',"purple", 'k', 'k', 'k', 'k']*10
        self.linestyles=['-','--','-',':']*10
    ...
    def run(self):
        name2="intrinsic_alignment_parameters--a1"
    ...
    def make_2d_plot(self, name1, name2):
        ...
        if self.labels is not None:
            leg=pylab.legend(self.proxies,self.labels,loc="upper right", fontsize=12)
